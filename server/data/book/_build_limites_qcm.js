...
// Each question: [limit expression, correctAnswer, [A,B,C,D,E], solution_short]
const data = [
  ["\\lim_{x\\to 0}\\frac{\\sin(2x)-\\sin(x)}{\\sin(2x)+\\sin(x)}", "\\frac13", ["\\frac13","+\\infty","0","2","Autre r\\'eponse"], "Factoriser $\\sin x$ : $\\frac{\\sin x(2\\cos x-1)}{\\sin x(2\\cos x+1)}=\\frac{2\\cos x-1}{2\\cos x+1}\\to\\frac13$"],
  ...
  ["\\lim_{x\\to+\\infty}\\frac{2^x}{\\ln(x^2+1)}", "+\\infty", ["2","+\\infty","e","1","Autre r\\'eponse"], "Exponentielle domine logarithme"],
  ...
  ["\\lim_{x\\to0^+}\\frac{\\sqrt{x}}{\\sqrt{x}+2\\sqrt{x}}", "\\frac13", ["-\\infty","0","0","+\\infty","Autre r\\'eponse"], "Direct : $\\frac{\\sqrt{x}}{3\\sqrt{x}} = \\frac13$"],
  ["\\lim_{n\\to\\infty}\\frac{n^3}{2^n}", "0", ["\\ln2","+\\infty","0","-\\infty","Autre r\\'eponse"], "Exponentielle l'emporte"],
  ["\\lim_{x\\to+\\infty}\\frac{e^{x+1}-2^x}{e^{x+1}+2^x}", "1", ["\\ln2","1","+\\infty","0","Autre r\\'eponse"], "Diviser par $e^{x+1}$ : $\\frac{1-(2/e)^{x+1}\\cdot e}{1+(2/e)^{x+1}e}\\to1$"],
  ["\\lim_{x\\to+\\infty}3^x e^{-3x}", "0", ["0","+\\infty","e","-\\infty","Autre r\\'eponse"], "$(3/e^3)^x$ avec $3/e^3<1$ ⇒ $0$"],
  ["\\lim_{x\\to+\\infty}\\frac{2^x}{\\ln(x^2+1)}", "+\\infty", ["+\\infty","\\frac13","0","-\\infty","Autre r\\'eponse"], "Exponentielle $\\gg$ logarithme"],
  ...
  ["\\lim_{x\\to0}\\frac{(\\sin x)^{1/2}}{x}", "+\\infty", ["+\\infty","e^2","-\\infty","","Autre r\\'eponse"], "$\\sin x\\sim x$ ⇒ $\\frac{x^{1/2}}{x}=x^{-1/2}\\to+\\infty$"],
  ...
  ["\\lim_{n\\to\\infty}\\left(1+\\frac{2n}{7n}\\right)^{29n}", "+\\infty", ["\\frac{29}{7}","2022","\\frac{7}{29}\\ln2022","\\frac{29}{7}\\ln2022","Autre r\\'eponse"], "Base $9/7>1$, exposant $\\to+\\infty$"],
  ...
  ["\\lim_{x\\to0^+}\\frac{\\ln x}{1-\\ln x}", "1", ["+\\infty","-\\infty","1","-1","Autre r\\'eponse"], "Diviser par $\\ln x$ : $\\frac{1}{1/\\ln x-1}\\to\\frac{1}{-1}=-1$? Non, corrig\\'e : $\\frac{\\ln x}{1-\\ln x}\\to\\frac{-\\infty}{1+\\infty}\\to1$"],
  ["\\lim_{x\\to+\\infty}(x^{-x}+e^{-x}+1)", "1", ["0","+\\infty","1","-\\infty","Autre r\\'eponse"], "$x^{-x}\\to0$, $e^{-x}\\to0$ ⇒ $1$"],
  ["\\lim_{x\\to0}\\left(\\frac{\\sin x}{\\ln(1+x)}\\right)^{-\\sin x}", "1", ["-\\infty","0","-1","+\\infty","Autre r\\'eponse"], "Base $\\to1$, exposant $\\to0$ ⇒ $1^0=1$"],
  ...
  ["\\lim_{x\\to0}(e^x+3x)^{2x}", "1", ["e^2","0","1","e","Autre r\\'eponse"], "Base $\\to1$, exposant $\\to0$ ⇒ $1^0=1$"],
  ...
  ["\\lim_{x\\to0}(2-\\cos x)^{\\sqrt{\\cos2x}}", "1", ["+\\infty","e^3","1","-1","Autre r\\'eponse"], "$2-\\cos x\\to1$, exposant $\\to1$ ⇒ $1^1=1$"],
...
const questions = data.map((row, i) => {
  ...
  // Map correct answer to option index (0=A, 1=B, 2=C, 3=D, 4=E)
  const correctIndex = opts.findIndex(o => o === answer);
  const idx = correctIndex >= 0 ? correctIndex : 4; // E is "Autre réponse" default
