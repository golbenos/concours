...
export default function Login() {
  ...
  return (
    <div className="max-w-sm mx-auto px-mobile py-16">
      <h1 className="font-headline-lg text-headline-lg text-center text-gray-800 dark:text-gray-100 mb-8">{t('login')}</h1>
      ...
      <p className="text-center font-caption text-caption text-gray-400 dark:text-gray-500 mt-5">{t('no_account')} <Link to="/register" className="text-emerald-600 hover:underline">{t('register')}</Link></p>
    </div>
  );
}
