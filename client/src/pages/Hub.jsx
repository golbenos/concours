  ...
  return (
    <div className="max-w-4xl mx-auto px-mobile py-16">
      <div className="text-center mb-12">
        <h1 className="font-headline-lg text-headline-lg text-gray-800 dark:text-gray-100 mb-3">{t('hub_title')}</h1>
        <p className="font-body-md text-body-md text-gray-400 dark:text-gray-500 max-w-lg mx-auto">{t('hub_subtitle')}</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {cards.map((card, i) => (
          ...
          >
            ...
            <h2 className="font-headline-md text-headline-md text-gray-800 dark:text-gray-100 mb-3">{t(card.titleKey)}</h2>
            <p className="font-body-md text-body-md text-gray-500 dark:text-gray-400 mb-6">{t(card.descKey)}</p>
